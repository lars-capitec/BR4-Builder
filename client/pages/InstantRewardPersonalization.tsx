...
export default function InstantRewardPersonalization() {
...
•	Offer cannot be sold or otherwise bartered`);
  ...
  const handleSave = () => {
    // Save current state
    console.log("Saving instant reward personalization data...");
  };
                ...
                <div className="pt-12 pb-6 px-6 space-y-4">
                  ...
                  <div className="flex flex-col items-center gap-4">
                    <div className="space-y-2 text-center">
                      <Label className="text-sm font-bold text-[#4A535C]">Spend amount</Label>
                      <div className="flex items-center justify-center gap-2">
                        <span className="text-base text-[#1F272E]">R</span>
                        <Input
                          value={spendAmount}
                          onChange={(e) => setSpendAmount(e.target.value)}
                          className="w-24 h-12 text-center text-base border-[#A1ACBA] rounded-xl"
                          placeholder="250"
                          type="number"
                          step="0.01"
                        />
